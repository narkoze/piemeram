    ...
    <div class="columns">
      <div class="column is-3">
        <div class="sticky is-marginless">
          <div class="field">
            <label>
              {{ role.id ? $t('blog.admin.views.blog-admin-view-roles.editrole') : $t('blog.admin.views.blog-admin-view-roles.newrole') }}
              <input
                v-model="role.name"
                type="text"
                ref="name"
      ...
      <div class="column">
        <div class="columns is-marginless-bottom">
          <div class="column">
            <div class="field">
              <label>{{ $t('blog.admin.views.blog-admin-view-roles.search') }}
                <input
                  :value="params.search"
                  @input="search"
                  type="text"
              ...
              >
                <td>
                  <a @click="(disabled || deleting) || setRole(role)">
                    <b v-html="$options.filters.highlight(role.name, params.search)"></b>
                  </a>
                ...
                <td v-html="$options.filters.highlight(role.description, params.search)"></td>
